  ...
  return (
    <div className="fixed inset-0 -z-50 overflow-hidden bg-background pointer-events-none">
      ...
      <motion.div
        ...
        className="absolute -top-[20%] -left-[10%] w-[70vw] h-[70vw] rounded-full bg-lime-500/10 blur-[120px]"
      />
      ...
      <motion.div
        ...
        className="absolute top-[20%] -right-[20%] w-[60vw] h-[60vw] rounded-full bg-emerald-500/10 blur-[120px]"
      />
