...
export default function SignupPage() {
  ...
  useEffect(() => {
    ...
    (window as any).onTurnstileLoadSignup = () => {
    ...
    return () => {
      ...
      delete (window as any).onTurnstileLoadSignup;
    };
  }, []);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black text-white px-4 py-8 relative overflow-hidden font-poppins">
